 ...
 * @description: 单词接龙2
 * @author: Shaobo.Qian
 * @create: 2020-06-09 14:36
 **/

public class lc_126_1 {
    public static void main(String[] args) {
        ...
        lc_126_1 solution = new lc_126_1();
     ...
     * @question:
     * 0.双向 BFS总体思路 分为哪两步?
     * 1.双向 BFS 记录被访问过的单词需要哪三个变量?
     * 2.使用什么来记录下一层要访问的节点元素?
     * 3.双向 BFS 的 beginVisited 和 endVisited 两个集合如何交替遍历,(即按什么条件顺序双向BFS)
     * 4. forward(Boolean)变量的作用?
     * 双向 BFS
     * @author Shaobo.Qian
     * @date 2020/6/9
